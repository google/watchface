...
/** A [[WatchFaceDocument]] implementation for the JS source set. */
class JsWatchFaceDocument private constructor(override val rootElement: WatchFaceElement) :
    WatchFaceDocument {
    ...
    companion object {
        ...
        fun of(document: Document): WatchFaceDocument {
            if (document.documentElement != null) {
                return JsWatchFaceDocument(toWatchFaceElement(document.documentElement!!))
            } else {
                throw Exception("Watch Face element not found")
            }
        }
